...
import RenderSearchBarDummy from "../../components/RenderSearchBar/RenderSearchBarDummy";
...
class Home extends Component {
  ...
  render() {
    return (
      <Block style={{ flex: 1, backgroundColor: "#FCFDFF" }}>
        <RenderSearchBarDummy />
        {/* <Button>Start</Button> */}
